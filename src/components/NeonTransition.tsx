...
const NeonTransition: React.FC = () => {
  return (
    <div className="relative w-full h-32 md:h-40 overflow-hidden">
      ...
      <div className="absolute top-0 w-full h-16 bg-gradient-to-b from-background to-transparent z-10"></div>
      <div className="absolute bottom-0 w-full h-16 bg-gradient-to-t from-background to-transparent z-10"></div>
    </div>
  );
};
