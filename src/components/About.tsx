  ...
  return (
    <section id="about" className="py-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* CV Section - Maintenant juste en dessous du titre */}
        <motion.div
          className="mb-12"
          ...
          <div className="glass-morphism p-6 rounded-2xl relative overflow-hidden border border-cyan-500/20 shadow-[0_0_30px_rgba(34,211,238,0.15)]">
            ...
            <div className="relative flex flex-col md:flex-row items-center gap-8">
              <div className="w-full md:w-1/4">
                ...
                >
                  {/* CV Image */}
                  <img src="/lovable-uploads/ad741a26-ddd7-4412-80a6-096b56f7bb86.png" alt="CV Nassim El Haddad" className="w-full h-full object-cover" />
                  
                  {/* Hover effect */}
                  <div className="absolute inset-0 bg-gradient-to-b from-transparent to-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-6">
                    <span className="text-white text-center font-medium">Mon CV</span>
                  </div>
                </motion.div>
              </div>
              ...
              <div className="w-full md:w-3/4 flex flex-col">
                ...
                <div className="flex flex-wrap gap-3">
                  <motion.button
                    className="flex items-center gap-2 px-4 py-3 rounded-lg glass-morphism hover:bg-cyan-500/10 transition-all duration-300 group"
                  ...
                  <motion.button
                    className={`flex items-center gap-2 px-4 py-3 rounded-lg ${hasDownloaded ? 'bg-green-500/20 text-green-300' : 'bg-gradient-to-r from-blue-500 to-cyan-500 text-white'} transition-all duration-300`}
                    whileHover={{ y: -5, boxShadow: "0 10px 25px -5px rgba(34,211,238,0.5)" }}
                    whileTap={{ scale: 0.95 }}
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
